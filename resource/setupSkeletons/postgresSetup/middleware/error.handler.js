...
const { Error, EagerLoadingError, ExclusionConstraintError } = require("sequelize")
...
module.exports = async (error, req, res, next) => {
    ...
    if (error instanceof Error || error instanceof EagerLoadingError || error instanceof ExclusionConstraintError) {
